...
| SRC-067 | OECD / European Commission — *Empowering Learners for the Age of AI: An AI Literacy Framework for Primary and Secondary Education* (OECD Publishing, 2026) · [link](https://doi.org/10.1787/65cd27d4-en) | Intergovernmental convergence on the same four-part structure — knowing, evaluating, using, and understanding implications. ⚠️ Scope: this is a framework for **primary and secondary education**, cited as evidence of convergence on what AI literacy means, not as a source about workforce literacy. ⚠️ The four-part structure was read from the **May 2025 review draft**; the citation now points to the final June 2026 edition, and the structure should be re-confirmed against it. |
