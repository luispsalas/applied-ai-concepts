...
|---|---|---|
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://doi.org/10.6028/NIST.AI.100-1) | The GOVERN function establishes accountability structures and the assignment of roles and responsibilities for AI systems — the framework basis for treating ownership as a governance requirement. |
