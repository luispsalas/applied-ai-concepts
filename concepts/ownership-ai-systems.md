...
|---|---|---|
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://www.nist.gov/itl/ai-risk-management-framework) | The GOVERN function establishes accountability structures and the assignment of roles and responsibilities for AI systems — the framework basis for treating ownership as a governance requirement. |
...
| SRC-039 | European Parliament / Council of the EU — *General Data Protection Regulation (EU) 2016/679* · [link](https://eur-lex.europa.eu/eli/reg/2016/679/oj) | Controller/processor accountability: the legal assignment of responsibility for data obligations — a regulatory precedent for naming who is answerable. |
