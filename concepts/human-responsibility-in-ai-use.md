...
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://doi.org/10.6028/NIST.AI.100-1) | GOVERN function: human oversight as an accountability structure; the framework basis for treating human responsibility as an operational governance requirement across the AI system lifecycle. |
