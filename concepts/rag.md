...
**Watch for:**
- Knowledge base treated as set-and-forget: populated once, never updated, with no process for identifying stale or superseded content. RAG makes the knowledge base authoritative; governance must match that authority.
...
| — | ⚠️ Source needed | Practitioner framing: retrieval ≠ search; quality ceiling shifts to knowledge base; operational deployment patterns. |
