...
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://airc.nist.gov/RMF) | GOVERN/MAP functions: documentation and logging requirements as accountability infrastructure; system-level traceability as a risk management requirement. |
