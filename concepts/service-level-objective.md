...
| SRC-047 | Wei, Jason et al. (Google Research, Brain Team) — *Chain-of-Thought Prompting Elicits Reasoning in Large Language Models* (2022) · [link](https://arxiv.org/abs/2201.11903) | Illustrates that output quality varies with prompting technique rather than being a fixed property of the deployed system — part of why a quality target must name the conditions it was measured under. |
