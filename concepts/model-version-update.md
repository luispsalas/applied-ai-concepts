...
| SRC-165 | Gama, J.; Žliobaitė, I.; Bifet, A.; Pechenizkiy, M.; Bouchachia, A. — *A survey on concept drift adaptation* (ACM Computing Surveys 46(4), 2014) · [link](https://doi.org/10.1145/2523813) | The established vocabulary for the other cause of the same symptom, and why distinguishing them determines the fix. |
