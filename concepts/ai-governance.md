...
|---|---|---|
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://www.nist.gov/itl/ai-risk-management-framework) | Primary framework reference: four-function structure (Govern, Map, Measure, Manage), risk management posture, organizational accountability design. Authoritative US government publication. |
| SRC-036 | Jobin, A.; Ienca, M.; Vayena, E. — *The global landscape of AI ethics guidelines* (Nature Machine Intelligence 1(9), pp. 389–399, 2019) · [link](https://doi.org/10.1038/s42256-019-0088-2) | Synthesis of 84+ AI ethics/governance guidelines globally; convergence around fairness, transparency, accountability, human oversight; fragmentation in implementation standards. Peer-reviewed. |
| SRC-129 | European Parliament — *EU Artificial Intelligence Act* (2024) · [link](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32024R1689) | Risk-tiered compliance model; extraterritorial scope for EU market deployment; prohibited AI practices; high-risk system requirements. Primary legal source. |
