...
|---|---|---|
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://doi.org/10.6028/NIST.AI.100-1) | Primary framework reference: four-function structure (Govern, Map, Measure, Manage), risk management posture, organizational accountability design. Authoritative US government publication. |
