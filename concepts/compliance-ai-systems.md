...
| SRC-001 | NIST — *Artificial Intelligence Risk Management Framework (AI RMF 1.0)* (2023) · [link](https://doi.org/10.6028/NIST.AI.100-1) | Voluntary compliance framework: Govern/Map/Measure/Manage functions as a structured approach to AI risk and compliance posture; widely referenced in public sector procurement and risk management. |
